# This package is no longer maintained as it is now replaced by the [pigments package](https://atom.io/packages/pigments). <br/>If both packages are installed this package will not activate.
